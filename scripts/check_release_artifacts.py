...
REQUIRED_WHEEL_SUFFIXES = (
    ...
    "ai_ratchet_gate/fact_output.py",
    "ai_ratchet_gate/fact_output_cli.py",
    "ai_ratchet_gate/harness.py",
    ...
    "ai_ratchet_gate/adapters/test_disable.py",
...
ALLOWED_SDIST_SUFFIXES = (
    ...
    "docs/adr/ADR-0004-skill-provenance-adapter.md",
    "docs/adr/ADR-0005-test-disable-adapter.md",
    "docs/adr/README.md",
    "scripts/verify.py",
    ...
    "src/ai_ratchet_gate/fact_output.py",
    "src/ai_ratchet_gate/fact_output_cli.py",
    "src/ai_ratchet_gate/harness.py",
    ...
    "src/ai_ratchet_gate/adapters/test_disable.py",
